...
public class PipeAndFilter {
    ...
    public static void main(String[] args) {
        ...
        filters.add(PipeAndFilter::multiplyByThree); 
    ...
    // THIS IS NEW FILTER THAT I HAVE ADDED: Multiply each number by 3
    private static List<Integer> multiplyByThree(List<Integer> input) {
        return input.stream()
                .map(n -> n * 3)
                .collect(Collectors.toList());
    }
